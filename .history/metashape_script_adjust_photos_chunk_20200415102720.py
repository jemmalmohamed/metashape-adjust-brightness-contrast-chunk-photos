...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def createImageViewerLayout(self):
        ...
        paths = self.getPaths(self.chunk)
        path = self.nextPhoto(paths)
    ...
    def getChankOnChange(self):
        chunk_key = self.chunksBox.currentData()
        self.chunk = self.chunks.findChunk(chunk_key)
    ...
    def nextPhoto(self, paths):
        self.path_photo = paths[0]
