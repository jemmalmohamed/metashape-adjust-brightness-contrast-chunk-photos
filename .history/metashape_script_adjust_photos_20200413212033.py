...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.photo.setPixmap(QtGui.QPixmap(path).scaled(900, 800, PySide2.QtCore.Qt.AspectRatioMode=Qt.IgnoreAspectRatio, PySide2.QtCore.Qt.TransformationMode=Qt.FastTransformation))
        self.photo.move(100, 150)
