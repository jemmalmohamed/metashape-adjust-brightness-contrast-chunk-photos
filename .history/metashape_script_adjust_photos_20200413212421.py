...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.photo.setPixmap(QtGui.QPixmap(path).scaled(900, 800,  QtCore.Qt.AspectRatioMode=Qt.IgnoreAspectRatio, QtCore.Qt.TransformationMode=Qt.FastTransformation))
