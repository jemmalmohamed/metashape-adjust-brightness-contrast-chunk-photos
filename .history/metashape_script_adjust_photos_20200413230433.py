...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.btnZoom = QtWidgets.QPushButton("+")
        self.btnZoom.setFixedSize(150, 23)
        ...
        layout.addWidget(self.btnZoom, 7, 1)
        ...
        QtCore.QObject.connect(
            self.btnZoom, QtCore.SIGNAL("clicked()"),  zoomIn)

        QtCore.QObject.connect(
            self.btnZoom, QtCore.SIGNAL("clicked()"),  zoomOut)
