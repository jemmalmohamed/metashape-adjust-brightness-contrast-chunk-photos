...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        layout.addWidget(self.label_brightness, 1, 2)
        layout.addWidget(self.brightness, 1, 2)
        layout.addWidget(self.label_contrast, 1, 2)
        layout.addWidget(self.contrast, 1, 2)
