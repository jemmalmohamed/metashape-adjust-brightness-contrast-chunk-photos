...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def copyChnukPhotos(self):
        ...
        #     proc_copy(len(chunks[chunk_key].cameras))
        ...
        #             proc_copy('last flight')
        #             i = i+1
        #             proc_copy('Flight {} : {} Photos'.format(
...
proc_copy("To execute this script press {}".format(label))
