...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        vboxViewer = QtWidgets.QVBoxLayout()
        vboxViewer.addWidget(self.groupBoxViewer)

        self.setLayout(vboxViewer)

        self.exec()

    def createImageViewer(self):

        self.groupBoxViewer = QtWidgets.QGroupBox('Viewer')
        ...
        self.groupBoxViewer.setLayout(gridLayout)
