...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def createImageViewerLayout(self):
        ...
        self.imageLabel.setMinimumHeight(600)
        self.imageLabel.setMinimumWidth(800)
    ...
    def createViewerButtons(self):
        ...
        self.btnFit = QtWidgets.QPushButton("fit")
        self.btnFit.setFixedSize(23, 23)

        gridViewerBtnLayout.addWidget(self.btnZoomIn, 0, 0)
        gridViewerBtnLayout.addWidget(self.btnZoomOut, 0, 1)
        gridViewerBtnLayout.addWidget(self.btnFit, 0, 2)
        ...
        # QtCore.QObject.connect(
        #     self.btnFit, QtCore.SIGNAL("clicked()"),  self.fitToWindow(True))
