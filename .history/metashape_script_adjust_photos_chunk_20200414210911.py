...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def createImageViewerLayout(self):
        ...
        gridViewerLayout.addWidget(self.imageLabel)
    ...
    def createParamsGridLayout(self):
        self.groupParamsBox = QtWidgets.QGroupBox('Adjustment parameters')
        ...
        gridLayout.addWidget(self.label_folder, 0, 2)
        gridLayout.addWidget(self.btn_select_folder, 0, 3)

        gridLayout.addWidget(self.label_brightness, 1, 0)
        gridLayout.addWidget(self.brightness, 1, 1)
        gridLayout.addWidget(self.path_label, 1, 2)

        gridLayout.addWidget(self.label_contrast, 2, 0)
        gridLayout.addWidget(self.contrast, 2, 1)

        gridLayout.addWidget(self.chunk_create_label, 2, 2)
        gridLayout.addWidget(self.chkCreateChunk, 2, 3)
        ...
        self.groupParamsBox.setLayout(gridLayout)
