...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def __init__(self, parent):
        ...
        self.chunksBox = QtWidgets.QComboBox(self)
        ...
        self.chkCreateChunk = QtWidgets.QCheckBox(self)
        ...
        self.createActions()
        # self.createMenus()
        self.chunksBox.currentIndexChanged.connect(
            self.chunksBox, self.chunksBox.currentData, self.changeChunk(chunks))
