...
class CopyChunkPhotosDlg(QtWidgets.QDialog):
    ...
    def createGridLayout(self):
        ...
        layout.addWidget(self.label_contrast, 2, 0)
        layout.addWidget(self.contrast, 2, 1)

        layout.addWidget(self.label_folder, 3, 0)
        layout.addWidget(self.btnAdd, 3, 0)

        layout.addWidget(self.chunk_create_label, 4, 0)
        layout.addWidget(self.chkCreateChunk, 4, 1)
